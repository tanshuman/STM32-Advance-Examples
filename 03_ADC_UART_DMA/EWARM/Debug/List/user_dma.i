...
void DMA_Configurations(void)
{
  ...
  DMA_Config.DMA_PeripheralBaseAddr = (uint32_t) 0x40012440; 
  DMA_Config.DMA_MemoryBaseAddr = (uint32_t)RegularConvData_Tab;
  DMA_Config.DMA_DIR = ((uint32_t)0x00000000);
  DMA_Config.DMA_BufferSize = 5;
  DMA_Config.DMA_PeripheralInc = ((uint32_t)0x00000000);
  DMA_Config.DMA_MemoryInc = ((uint32_t)0x00000080);
  DMA_Config.DMA_PeripheralDataSize = ((uint32_t)0x00000100);
  DMA_Config.DMA_MemoryDataSize = ((uint32_t)0x00000400);
  DMA_Config.DMA_Mode = ((uint32_t)0x00000020);
  DMA_Config.DMA_Priority = ((uint32_t)0x00002000);
  DMA_Config.DMA_M2M = ((uint32_t)0x00000000);
  DMA_Init(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008)), &DMA_Config);
