...
void USART_Configurations(void)
{
  ...
  USART_Config.USART_WordLength = ((uint32_t)0x00000000);
  USART_Config.USART_StopBits = ((uint32_t)0x00000000);
  USART_Config.USART_Parity = ((uint32_t)0x00000000);
  USART_Config.USART_HardwareFlowControl = ((uint32_t)0x00000000);
  USART_Config.USART_Mode = ((uint32_t)0x00000004) | ((uint32_t)0x00000008);

  USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), &USART_Config);
...
uint8_t usart1_out(char* pbuffer)
{
  while(*pbuffer)
  {
    if(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), ((uint32_t)0x00000080)) != RESET)
    {   
      USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), *pbuffer++); 
  
    }
    while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), ((uint32_t)0x00000040)) == RESET); 
...
int fputc(int ch, FILE *f)
{
  ...
  USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), (uint8_t) ch);
