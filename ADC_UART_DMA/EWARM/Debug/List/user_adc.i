...
void ADC_Configurations(void)
{
  ...
  ADC_Config.ADC_Resolution = ((uint32_t)0x00000000);
  ADC_Config.ADC_ContinuousConvMode = ENABLE;
  ADC_Config.ADC_DataAlign = ((uint32_t)0x00000000);
  ADC_Config.ADC_ScanDirection = ((uint32_t)0x00000000);
  ADC_Config.ADC_ExternalTrigConvEdge = ((uint32_t)0x00000000);
  ADC_Config.ADC_ExternalTrigConv = ((uint32_t)0x00000000);
  ADC_Init(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), &ADC_Config);
  
  
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)0x00000002), ((uint32_t)0x00000005));
  
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)0x00000004), ((uint32_t)0x00000005));
  
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)0x00000040), ((uint32_t)0x00000005));
  
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)((uint32_t)0x00010000)) , ((uint32_t)0x00000005));  
  ADC_TempSensorCmd(ENABLE);
  
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)((uint32_t)0x00040000)) , ((uint32_t)0x00000005));  
  ADC_VbatCmd(ENABLE);
