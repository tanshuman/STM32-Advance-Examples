...
uint8_t Clk_Config(void)
{
  ...
  while(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CR2&0x2 != 0x2) ; 
  
  
  RCC_PREDIV1Config(((uint32_t)0x00000003));  
  RCC_PLLConfig(((uint32_t)0x00018000), ((uint32_t)0x00000000)); 
  RCC_PLLCmd(ENABLE); 
  while(!RCC_GetFlagStatus(((uint8_t)0x19))) ; 
  ...
  RCC_PCLKConfig(((uint32_t)0x00000000)); 
  ...
  RCC_ADCCLKConfig(((uint32_t)0x00000000));
  
  
  RCC_USARTCLKConfig(((uint32_t)0x10000001));
  RCC_USARTCLKConfig(((uint32_t)0x20030000));
...
uint8_t RCC_Config(void)
{
  ...
  RCC_AHBPeriphClockCmd(((uint32_t)0x00200000), ENABLE);  
...
uint8_t GPIO_Config(void)
{
  ...
  GPIO_Config.GPIO_Pin = ((uint16_t)0x0100);
  GPIO_Config.GPIO_Mode = GPIO_Mode_AF;
  GPIO_Config.GPIO_Speed = GPIO_Speed_Level_3;
  GPIO_Config.GPIO_OType = GPIO_OType_PP;
  GPIO_Config.GPIO_PuPd = GPIO_PuPd_UP;
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), &GPIO_Config);  
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x08), ((uint8_t)0x00)); 
  
  RCC_MCOConfig(((uint8_t)0x04), ((uint32_t)0x00000000)); 
  
  GPIO_Config.GPIO_Pin = ((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800);
  
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), &GPIO_Config);
  
  
  GPIO_Config.GPIO_Pin = ((uint16_t)0x0080);
  GPIO_Config.GPIO_Mode = GPIO_Mode_OUT;
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), &GPIO_Config);
  
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint8_t)0x08), ((uint8_t)0x00)); 
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint8_t)0x09), ((uint8_t)0x00));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint8_t)0x0A), ((uint8_t)0x00));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint8_t)0x0B), ((uint8_t)0x00));
...
uint8_t TIM_Config(void)
{
  ...
  TIM_Config.TIM_Prescaler = 0x0; 
  TIM_Config.TIM_CounterMode = ((uint16_t)0x0000); 
  TIM_Config.TIM_Period = 2400; 
  TIM_Config.TIM_ClockDivision = ((uint16_t)0x0000); 
  TIM_Config.TIM_RepetitionCounter = 0x00; 
  TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), &TIM_Config);
  ...
  TIM_OC1PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ((uint16_t)0x0008));
  
  TIM_OC2Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), &TIM_OCInitStructure);
  TIM_OC2PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ((uint16_t)0x0008));
  
  
  TIM_ITConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ((uint16_t)0x0001), ENABLE);
