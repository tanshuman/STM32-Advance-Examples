...
int main()
{
  ...
  while(1) 
  {
    ...
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint16_t)0x0080));
    for(int j=0; j<90 ;j++)
      for(int i=0; i<=500000; i++);
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001000)), ((uint16_t)0x0080));
    for(int j=0; j<90 ;j++)
      for(int i=0; i<=500000; i++);
  }
...
{
  if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ((uint16_t)0x0001)) != RESET)
  {
    TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ((uint16_t)0x0001));
    if(counter > 0 && counter <= 48)
      ...
      pulse_pwm -= 50;
    if(counter < 100)
      TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), pulse_pwm);
    else if(counter > 100 && counter < 200)
      TIM_SetCompare2(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), pulse_pwm);
    counter++;
    if(counter >= 200)
    {
     counter = 1;
