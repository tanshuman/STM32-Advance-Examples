...
uint32_t I2C1_WriteBuffer(uint8_t* pBuffer, uint16_t DeviceAddr, uint16_t DeviceAddrByteSize, uint16_t WriteAddr, uint16_t NumByteToWrite)
{
  ...
  I2C_TransferHandling(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), DeviceAddr, DeviceAddrByteSize , ((uint32_t)0x01000000), ((uint32_t)0x00002000));
  if(!i2c_check())  return 0;
  
   
  if(DeviceAddrByteSize == 2)
  {
    I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), (uint8_t)((WriteAddr & 0xFF00) >> 8));
    if(!i2c_check())  return 0;
  }
  
   
  I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), (uint8_t)(WriteAddr & 0x00FF));
  uint32_t FramTimeout = ((uint32_t)(10 * ((uint32_t)0x2000)));
   
  while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000080)) == RESET)
  {
  ...
  I2C_TransferHandling(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), DeviceAddr, (uint32_t)(NumByteToWrite), ((uint32_t)0x02000000), ((uint32_t)0x00000000));
  
   
  for(int i=0; i < (NumByteToWrite); i++)
  {
    if(!i2c_check())  return 0;
    I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), (uint8_t)(pBuffer[i]));
  }
  
   
  FramTimeout = ((uint32_t)(10 * ((uint32_t)0x2000)));  
  while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000020)) == RESET)
    if((FramTimeout--) == 0) return 0;
  
   
  I2C_ClearFlag(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000020));
  return 1;
}
...
uint32_t I2C1_ReadBuffer(uint8_t* pBuffer, uint16_t DeviceAddr, uint16_t DeviceAddrByteSize, uint16_t WriteAddr, uint16_t NumByteToWrite)
{
  ...
  I2C_TransferHandling(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), DeviceAddr, DeviceAddrByteSize , ((uint32_t)0x00000000), ((uint32_t)0x00002000));
  if(!i2c_check())  return 0;
  ...
  while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000040)) == RESET)
  {
    if((FramTimeout--) == 0) return 0;
  }
  
   
  I2C_TransferHandling(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), DeviceAddr, (uint32_t)(NumByteToWrite), ((uint32_t)0x02000000), (uint32_t)(((uint32_t)0x00002000) | ((uint32_t)0x00000400)));
  ...
  for(int i=0; i < (NumByteToWrite); i++)
  {
    ...
    FramTimeout = ((uint32_t)(10 * ((uint32_t)0x2000)));
    while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000004)) == RESET)
    {
      if((FramTimeout--) == 0) return 0;
    }
    
     
    pBuffer[i]= I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)));
  }
...
{
  uint32_t FramTimeout = ((uint32_t)(10 * ((uint32_t)0x2000)));
  while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000002)) == RESET) 
  {
    if((FramTimeout--) == 0) 
      return 0; 
  }
