...
void GPIO_Configurations(void)
{
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), ((uint8_t)0x06), ((uint8_t)0x01));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), ((uint8_t)0x07), ((uint8_t)0x01));
...
void USART_Configurations(void)
{
  ...
  USART_InitStructure.USART_StopBits = ((uint32_t)0x00000000);
  USART_InitStructure.USART_Parity = ((uint32_t)0x00000000);
  USART_InitStructure.USART_HardwareFlowControl = ((uint32_t)0x00000000);
  USART_InitStructure.USART_Mode = ((uint32_t)0x00000004) | ((uint32_t)0x00000008);

  USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)), &USART_InitStructure);
...
void I2C_Configurations(void)
{
  ...
  I2C_InitStructure.I2C_OwnAddress1 = 0x57; 
  ...
  I2C_ITConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ((uint32_t)0x00000004), ENABLE); 
...
void ADC_Configurations(void)
{
  ...
  ADC_InitStructure.ADC_ExternalTrigConv = ((uint32_t)0x00000040);
  ...
  ADC_ChannelConfig(((ADC_TypeDef *) (((uint32_t)0x40000000) + 0x00012400)), ((uint32_t)0x00000040), ((uint32_t)0x00000000));
